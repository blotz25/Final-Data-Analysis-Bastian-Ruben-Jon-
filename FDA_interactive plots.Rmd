...
```{r, echo=FALSE}
interactive5 <- ACLED_full_long_no_others %>% 
...
interactive <- ACLED_full %>% 
  ...
  mutate(sum_fatalties = sum(FATALITIES, na.rm = TRUE)) %>% 
  ggplot(aes(ceiling_date(EVENT_DATE, "month"), sum_fatalties)) + 
